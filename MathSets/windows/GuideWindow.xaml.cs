...
namespace MathSets.windows
{
    ...
    public partial class GuideWindow : Window
    {
        ...
        public GuideWindow(int themeNumber, int taskNumber)
        {
            ...
            {
                _status = false;
                string pathCurrentDirectory = System.IO.Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location) + "\\video\\"; // Путь до папки, где хранятся видео.
                switch (themeNumber)
                {
                    case 1:
                        if (taskNumber == 1)
            ...
            {
                MessageBox.Show("При открытие видеоинструкции возникла ошибка");
            }
        }
